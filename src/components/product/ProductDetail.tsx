...
const productFaqs: Record<string, { q: string; a: string }[]> = {
  'hindu-kush-feminized': [
    ...
    { q: 'Can I grow Hindu Kush Feminized outdoors in Australia?', a: 'Yes. Hindu Kush originates from harsh mountain climates, so it handles cool Canadian nights better than most strains. It performs well outdoors in BC, New York, and Florida, with harvest typically ready by late September to early October.' },
  ...
  'og-kush-feminized': [
    ...
    { q: 'How long does OG Kush Feminized take to flower?', a: 'OG Kush Feminized flowers in approximately 8-9 weeks indoors under a 12/12 light cycle. Outdoor growers in Australia can expect harvest readiness around early to mid-October, depending on regional climate conditions.' },
