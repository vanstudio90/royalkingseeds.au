          ...
          {(() => {
            ...
            return (
              <div className="absolute bottom-3 left-3 flex flex-col gap-1">
                {badges.map((b) => (
                  <span key={b.text} className={`text-[9px] sm:text-[10px] font-semibold px-2 py-0.5 sm:py-1 rounded-full ${b.bg} ${b.textColor} flex items-center gap-1 shadow-sm`}>
      ...
      <div className="mt-auto pt-3 sm:pt-4 border-t border-[#F5F0EA]">
        <div className="text-center mb-2">
          <span className="text-lg sm:text-xl font-semibold text-[#275C53]">
            ...
            <span className="text-[10px] sm:text-[11px] text-[#192026]/70 ml-1 font-normal">AUD</span>
          </span>
        </div>
        <button
