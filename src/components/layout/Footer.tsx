    ...
    <footer>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-10 sm:py-12">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left max-w-md">
              ...
              <p className="text-white/70 text-sm mt-1.5">Join Australian growers getting strain drops, grow guides, and special offers. Unsubscribe anytime.</p>
            </div>
            {subscribed ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-10">
            ...
            <div className="col-span-2 sm:col-span-3 lg:col-span-2">
              ...
              <p className="text-sm text-[#192026]/70 leading-relaxed max-w-xs">
                Trusted by growers across Australia for premium seed genetics, discreet delivery, and responsive support before and after purchase.
              </p>
              <div className="mt-5 space-y-2">
                <div className="flex items-center gap-2 text-sm text-[#192026]/75">
                  ...
                  <a href="mailto:support@royalkingseeds.au" className="hover:text-[#275C53] transition-colors">support@royalkingseeds.au</a>
                </div>
                <div className="flex items-center gap-2 text-sm text-[#192026]/75">
                ...
                <div className="flex items-center gap-2 text-sm text-[#192026]/75">
                  ...
                  <span>Ships across all Australian states &amp; territories</span>
                </div>
              </div>
              <div className="mt-5">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/product-category/shop-all-cannabis-seeds" className={linkClass}>Premium Seeds</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><Link href="/seeds/australia" className={linkClass}>All States &amp; Territories</Link></li>
                <li><Link href="/seeds/australia/new-south-wales" className={linkClass}>New South Wales</Link></li>
                <li><Link href="/seeds/australia/victoria" className={linkClass}>Victoria</Link></li>
                <li><Link href="/seeds/australia/queensland" className={linkClass}>Queensland</Link></li>
                <li><Link href="/seeds/australia/western-australia" className={linkClass}>Western Australia</Link></li>
                <li><Link href="/seeds/australia/south-australia" className={linkClass}>South Australia</Link></li>
                <li><Link href="/seeds/australia/tasmania" className={linkClass}>Tasmania</Link></li>
                <li><Link href="/seeds/australia/act" className={linkClass}>ACT</Link></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#EDE8E1] border-t border-[#275C53]/5">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-10">
          <h4 className="text-center text-xs uppercase tracking-[1.5px] text-[#275C53] font-semibold mb-8">Why Australian Growers Trust Us</h4>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {[
              ...
              },
              {
                ...
                title: 'Discreet AU Shipping',
                desc: 'Plain outer packaging. Fast delivery to all states and territories.',
                link: '/shipping',
              },
              {
              ...
              },
              {
                ...
                title: 'Fast AU Delivery',
                desc: 'Quick shipping across all Australian states and territories.',
                link: '/shipping',
              },
              {
