...
const navItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'New South Wales', href: '/seeds/australia/new-south-wales' },
      { label: 'Victoria', href: '/seeds/australia/victoria' },
      { label: 'Queensland', href: '/seeds/australia/queensland' },
      { label: 'Western Australia', href: '/seeds/australia/western-australia' },
      { label: 'South Australia', href: '/seeds/australia/south-australia' },
      { label: 'ACT', href: '/seeds/australia/australian-capital-territory' },
      { label: 'All States & Territories', href: '/seeds/australia' },
    ],
  },
  {
    label: 'Support',
