        ...
        {items.length > 0 && (
          <div className="border-t border-[#F5F0EA] px-6 py-5 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xl font-semibold text-[#275C53]">${totalPrice().toFixed(2)} AUD</span>
            </div>
            <p className="text-xs text-[#192026]/70">Free shipping on orders over $150 AUD across Australia.</p>
