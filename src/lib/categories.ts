...
export const categories: Category[] = [
  ...
  { name: 'Australian Premium Cannabis Seeds', slug: 'australian-premium-cannabis-seeds', parent: 'shop-all-cannabis-seeds' },
  { name: "Grower's Choice Collection", slug: 'growers-choice-seeds-collection', parent: 'australian-premium-cannabis-seeds' },
