...
export const categoryContent: Record<string, CategoryContent> = {
  'shop-all-cannabis-seeds': {
    h1: 'Buy Cannabis Seeds Online in Australia — 1,600+ Premium Strains',
    intro: 'Royal King Seeds is your trusted Australian source for premium cannabis seeds. Browse our complete collection of over 1,600 feminised, autoflowering, indica, sativa, hybrid, and CBD strains with discreet shipping to all Australian states and territories. Every seed order includes our 95% germination guarantee, competitive pricing, and expert growing support for cultivators of all experience levels across Australia. Whether you are a first-time grower starting with easy autoflowers or an experienced cultivator chasing maximum potency, our catalogue has the right genetics for your goals. Use our strain finder quiz to get personalised recommendations or explore our yield calculator to estimate your harvest.',
    quickFacts: [
      { label: 'Total Strains', value: '1,600+' },
      { label: 'Germination Rate', value: '95%' },
      { label: 'Shipping', value: 'All States & Territories' },
      { label: 'Free Shipping', value: 'Orders $150+' },
    ],
    bottomSections: [
      { title: 'Why Buy Cannabis Seeds From Royal King Seeds?', content: 'Royal King Seeds combines an extensive seed catalogue with genuine customer care that sets us apart from other Australian seed banks. Our genetics are sourced from reputable breeders worldwide, stored in climate-controlled conditions, and shipped in protective packaging to maintain viability. Australian growers trust us because we deliver consistent results, transparent strain information, and responsive support that helps you succeed from germination through harvest. With over 200,000 orders fulfilled since 2019, we have the track record to back our promises.' },
      { title: 'Cannabis Seed Types Available for Australian Growers', content: 'Our catalogue includes feminised cannabis seeds (guaranteed 99.9% female plants), autoflowering seeds (flower automatically in 8-10 weeks), CBD-rich varieties for therapeutic growers, high-THC strains for experienced cultivators, and curated mix packs for those who want variety. Whether you are growing indoors in a small apartment in Sydney or outdoors in the Queensland sun, we have genetics suited to your environment and goals. Use our yield calculator to estimate your harvest based on your specific setup.' },
      { title: 'How to Choose the Right Cannabis Seeds', content: 'Consider your growing environment (indoor vs outdoor), experience level, desired effects, and your local climate. Beginners should start with autoflowering seeds — they flower automatically, stay compact, and finish in 8-10 weeks. Intermediate growers often prefer feminised photoperiod seeds for larger yields and more control. Advanced cultivators may explore exotic genetics, high-THC strains, or breeding projects. Our strain finder quiz helps you narrow down the best options in under 60 seconds.' },
      { title: 'Autoflower vs Feminised Seeds — Which Should You Choose?', content: 'Autoflowering seeds are faster (8-10 weeks seed to harvest), stay smaller, and allow multiple harvests per year. Feminised photoperiod seeds produce larger plants, heavier individual harvests, and offer more control over plant size through vegetative growth timing. For beginners and limited spaces, autoflowers are ideal. For maximum single-harvest yield, feminised seeds win. Many experienced growers run both types simultaneously.' },
      { title: 'Tips for Growing Cannabis Seeds Successfully in Australia', content: 'Start with quality genetics — strain selection is the single biggest factor in your results. Germinate seeds using the paper towel method or direct soil planting. Maintain proper temperature (21-30\u00B0C), humidity (40-60% during flower), and pH (6.0-6.5 in soil). Use quality lighting — LED or HPS for indoor grows. Feed conservatively and increase gradually. Train your plants with LST or topping for bigger yields. Australian outdoor growers should note that the main growing season runs from October to April, with harvests typically in March-April. Check our complete grow guide library for detailed instructions on every stage from seed to harvest.' },
    ],
    faqs: [
      { q: 'Is it legal to buy cannabis seeds in Australia?', a: 'Cannabis seeds are sold as adult novelty souvenirs and for genetic preservation. Laws regarding germination vary by state and territory. Buyers are responsible for understanding local regulations. The ACT permits limited personal cultivation for adults, while other jurisdictions have varying rules.' },
      { q: 'How do I choose the right cannabis seeds?', a: 'Consider your growing environment (indoor vs outdoor), experience level, desired effects, and climate. Beginners should start with autoflowering or feminised seeds. Take our strain finder quiz for personalised recommendations based on your specific needs.' },
      ...
      { q: 'How long does shipping take?', a: 'Orders ship within 1-2 business days. Most Australian deliveries arrive in 3-7 business days via Australia Post. All orders ship in plain, unmarked packaging for complete discretion. Free shipping on orders over $150 AUD.' },
      { q: 'What is the difference between autoflower and feminised seeds?', a: 'Autoflowers flower based on age (8-10 weeks total), stay compact, and are beginner-friendly. Feminised photoperiod seeds require a light cycle change to flower, grow larger, and produce heavier individual harvests. Both types produce only female plants.' },
      { q: 'Do you ship to all Australian states and territories?', a: 'Yes. We ship cannabis seeds to all Australian states and territories using plain, unmarked packaging. Every order includes tracking information. Free shipping is available on orders over $150 AUD.' },
    ],
  },
  'feminized-seeds': {
    h1: 'Feminised Cannabis Seeds Australia — Guaranteed 99.9% Female Plants',
    intro: 'Shop the largest selection of feminised cannabis seeds available online in Australia. Feminised seeds are genetically engineered to produce 99.9% female plants, eliminating the need to identify and remove males. This means every seed you plant has the potential to produce harvestable, cannabinoid-rich flowers. Browse indica-dominant, sativa-dominant, and hybrid feminised genetics — from classic strains like OG Kush and White Widow to modern favourites like Gelato and Wedding Cake. All with discreet Australian shipping and our 95% germination guarantee.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'What Are Feminised Cannabis Seeds?', content: 'Feminised cannabis seeds are bred using a process that eliminates male chromosomes, resulting in seeds that produce almost exclusively female plants. Female plants are the ones that produce the resin-rich buds that cultivators harvest for their cannabinoid and terpene content. By choosing feminised seeds, you avoid the time, space, and resource waste of growing and identifying male plants. The feminisation process uses techniques like colloidal silver or rodelization to ensure stable, reliable female genetics generation after generation.' },
      { title: 'Best Feminised Seeds for Indoor Growing', content: 'Indoor growers benefit enormously from feminised seeds because every plant counts when space is limited. Compact indica-dominant feminised strains like Northern Lights, Girl Scout Cookies, and Granddaddy Purple thrive in 4x4 tents under LED lighting. Use training techniques like LST, topping, or ScrOG to maximise your canopy coverage. Most feminised indicas finish flowering in 8-9 weeks, while sativa-dominant varieties take 10-11 weeks. Check our yield calculator to estimate your harvest based on your specific indoor setup.' },
      { title: 'How to Choose the Right Feminised Strain', content: 'Start with your growing environment. Indoor growers should prioritise compact, fast-flowering strains. Outdoor growers in warm climates can choose taller sativa-dominant varieties. Consider THC content — beginners should start with moderate-THC strains (15-20%) before moving to high-potency options. Think about your desired effects: indica for relaxation, sativa for energy, hybrid for balance. Finally, check flowering time — shorter flower times mean faster harvests and less risk of mould in humid climates.' },
      { title: 'Feminised vs Autoflower Seeds — Which Is Better?', content: 'Feminised photoperiod seeds give you more control. You decide when to flip to flower by changing the light cycle, allowing you to grow plants as large as you want during veg. This means higher yields per plant — typically 2-8 ounces indoor. Autoflowers are faster and simpler but produce smaller individual harvests. For maximum yield per grow cycle, choose feminised. For speed and simplicity, choose autoflowers. Many experienced growers run both — autoflowers for quick harvests and feminised for their main crop.' },
      { title: 'Growing Tips for Feminised Cannabis Seeds', content: 'Germinate using the paper towel method for best results. Transplant seedlings into their final container early to minimise root stress. During vegetative growth, run 18/6 light cycle and focus on building a strong root system. Top or FIM your plants at the 4th-5th node for bushier growth. Flip to 12/12 when plants reach half your desired final height — they will stretch 50-100% during flower. Feed bloom nutrients once you see pistils forming. Monitor trichomes with a jeweller\u2019s loupe to determine optimal harvest time.' },
    ],
    faqs: [
      { q: 'What makes feminised seeds different from regular seeds?', a: 'Regular seeds have a roughly 50/50 chance of producing male or female plants. Feminised seeds are bred to produce 99.9% female plants, meaning virtually every seed becomes a harvestable, bud-producing plant. This eliminates wasted time and resources on males.' },
      { q: 'Are feminised seeds suitable for beginners?', a: 'Yes. Feminised seeds simplify growing by eliminating sex identification. Combined with straightforward feeding and lighting schedules, they are an excellent choice for first-time growers who want guaranteed female plants.' },
      { q: 'Can I clone feminised cannabis plants?', a: 'Absolutely. Feminised plants make excellent mothers for cloning. Take cuttings during the vegetative stage to produce genetically identical female plants. This is a cost-effective way to multiply your best-performing genetics.' },
      { q: 'How much do feminised plants yield?', a: 'Indoor feminised plants typically yield 1-4 ounces per plant in a standard tent setup, with trained plants reaching 4-8 ounces. Outdoor plants can yield significantly more — 8-16+ ounces per plant depending on strain and growing conditions. Use our yield calculator for personalised estimates.' },
      { q: 'What is the best feminised strain for beginners?', a: 'Northern Lights Feminised is widely considered the best beginner strain. It stays compact, tolerates feeding mistakes, resists mould, and finishes in 8 weeks of flowering. White Widow and Blue Dream are also excellent beginner-friendly feminised options.' },
      { q: 'Do feminised seeds produce less potent buds?', a: 'No. Feminised seeds produce buds identical in potency to regular seeds of the same strain. The feminisation process affects only the sex chromosome — it does not change THC content, terpene profiles, or any other quality metrics.' },
    ],
    relatedCategories: [
  ...
  'autoflowering-seeds': {
    ...
    bottomSections: [
      { title: 'Why Choose Autoflowering Seeds?', content: 'Autoflowering cannabis seeds contain ruderalis genetics that trigger flowering based on the plant age, typically 3-4 weeks after germination. This means they do not require light cycle manipulation, stay compact (2-4 feet), and finish in as little as 8-10 weeks from seed. For Australian growers with limited indoor space or simply wanting fast results, autoflowers are the ideal solution. Outdoor growers in Australia can plant autoflowers from early spring (September) through late summer (February) and fit in multiple harvests per season. Modern autoflowers produce THC levels rivalling photoperiod strains while maintaining their speed advantage.' },
    ...
    faqs: [
      ...
      { q: 'Can I grow autoflowers outdoors in Australia?', a: 'Absolutely. Autoflowers are excellent for outdoor growing in every Australian climate. They can be planted from early spring (September) through late summer, and their short lifecycle means you can complete 2-3 outdoor harvests per season in warmer regions like Queensland and Northern Territory.' },
      { q: 'How much do autoflowers yield?', a: 'Individual autoflower plants typically yield 1-4 ounces depending on strain, container size, and growing conditions. Indoor growers can achieve 350-500g per square metre. The trade-off for lower per-plant yield is more harvests per year.' },
  ...
  'indica-seeds': {
    h1: 'Indica Cannabis Seeds Australia — Relaxing Strains for Evening Use',
    intro: 'Indica cannabis seeds produce plants known for deep physical relaxation, sedative effects, and compact growing structures. These strains are preferred by Australian growers seeking nighttime relief, pain management, sleep support, and stress reduction. Indica plants stay shorter and bushier than sativas, making them ideal for indoor cultivation and limited grow spaces. Browse our full indica seed collection featuring genetics from classic Afghan landraces to modern indica-dominant hybrids, all with discreet Australian shipping and our germination guarantee.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Best Indica Strains for Indoor Growing', content: 'Indica plants are naturally compact, making them the ideal choice for indoor tent cultivation. Top indoor indica strains include Northern Lights (the gold standard for indoor growing), Granddaddy Purple (stunning purple colours and grape flavour), Bubba Kush (heavy relaxation), and Hindu Kush (pure landrace genetics). Most indica strains finish flowering in 7-9 weeks and respond exceptionally well to training techniques like ScrOG and LST. Use our yield calculator to estimate your indoor indica harvest.' },
      { title: 'How to Choose the Right Indica Strain', content: 'Consider your primary goal. For sleep support, choose heavy indicas like Granddaddy Purple or Northern Lights. For pain relief with less sedation, try a balanced indica-hybrid like Girl Scout Cookies. For flavour, Purple Punch and Blueberry deliver exceptional taste. Check THC content — heavy indicas can exceed 25% THC, which may be overwhelming for beginners. Start with moderate-potency indicas (15-20% THC) and work up.' },
      { title: 'Indica vs Sativa — Understanding the Difference', content: 'Indica and sativa represent two ends of the cannabis spectrum. Indicas produce body-heavy, sedating effects ideal for evening use. Sativas produce cerebral, energising effects better suited for daytime. Indicas grow shorter with wider leaves and denser buds. Sativas grow taller with narrow leaves and elongated flower structures. Most modern strains are hybrids containing both indica and sativa genetics in varying ratios. Your ideal choice depends on when you plan to consume and what effects you prefer.' },
      { title: 'Growing Tips for Indica Seeds', content: 'Indica plants are naturally compact and bushy, requiring less height management than sativas. Provide strong lighting during flower for the densest buds. Watch humidity carefully during late flowering — indica buds are dense and prone to mould in humid conditions. Keep relative humidity below 50% during the last 3 weeks of flower. Feed with bloom-heavy nutrients once flowering begins. Indica strains respond well to defoliation to improve airflow and light penetration into the canopy.' },
    ],
    faqs: [
      ...
      { q: 'Can I grow indica seeds outdoors in Australia?', a: 'Yes. Indica strains perform well outdoors across most of Australia. Their shorter flowering times mean they finish well before the cooler months. Indicas handle cooler nighttime temperatures well, and some strains develop beautiful purple colouring when exposed to cool autumn nights.' },
      ...
      { q: 'How much do indica plants yield?', a: 'Indoor indica plants typically yield 350-500g per square metre. Individual plants produce 1-4 ounces in standard setups, or more with training. Outdoor indica plants can yield 8-16 ounces per plant with adequate space and sunlight.' },
    ],
  },
  'sativa-seeds': {
    h1: 'Sativa Cannabis Seeds Australia — Energising Daytime Strains',
    intro: 'Sativa cannabis seeds produce tall, vigorous plants celebrated for their cerebral, energising, and uplifting effects. Australian growers choose sativa genetics for creativity, focus, social enhancement, and daytime productivity. Our sativa seed collection includes classic Haze varieties, tropical landrace genetics, and modern sativa-dominant hybrids that have been bred for manageable indoor growing while retaining the signature sativa experience.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Best Sativa Strains for Australian Growers', content: 'Our sativa collection features legendary genetics including Jack Herer (cerebral clarity), Sour Diesel (intense energy), Amnesia Haze (creative euphoria), and Super Lemon Haze (citrus-forward flavour). For indoor growers concerned about height, sativa-dominant hybrids like Blue Dream and Green Crack offer manageable growth patterns while delivering authentic sativa effects. Outdoor growers in Queensland, Northern Territory, and Western Australia can take full advantage of pure sativa genetics in the warm Australian climate.' },
    ...
    faqs: [
      ...
      { q: 'What is the best sativa strain for energy?', a: 'Sour Diesel, Green Crack, and Jack Herer are consistently rated as the most energising sativa strains. They deliver clean, focused energy without anxiety or paranoia, making them ideal for daytime productivity.' },
      ...
      { q: 'What THC levels do sativa strains reach?', a: 'Sativa THC levels range from 15-28% depending on the strain. High-potency sativas like Ghost Train Haze and Bruce Banner can exceed 25% THC. Many sativas also produce notable THCV levels, contributing to their energising effects.' },
    ],
  },
  'hybrid': {
    h1: 'Hybrid Cannabis Seeds Australia — Balanced Indica/Sativa Genetics',
    intro: 'Hybrid cannabis seeds combine the best characteristics of indica and sativa genetics, offering balanced effects, versatile growing profiles, and diverse flavour profiles. Whether you want a 50/50 balance, an indica-leaning relaxer, or a sativa-dominant energiser, our hybrid collection delivers options for every Australian grower. Hybrids represent the most popular category of cannabis seeds and include iconic strains like Girl Scout Cookies, Gorilla Glue, and Wedding Cake.',
    quickFacts: [
    ...
    faqs: [
      ...
      { q: 'What is the most popular hybrid strain?', a: 'Girl Scout Cookies (GSC), Gorilla Glue (GG4), Blue Dream, OG Kush, and Wedding Cake are among the most popular hybrid strains in Australia. They are consistently top sellers due to their balanced effects and reliable growing performance.' },
      { q: 'How much do hybrid plants yield?', a: 'Hybrid yields vary by strain but typically range from 400-600g per square metre indoors. Outdoor hybrid plants can produce 500-1000g+ per plant. Many high-yield hybrid strains have been specifically bred for maximum harvest weight.' },
  ...
  'cbd-strains': {
    ...
    faqs: [
      ...
      { q: 'Are CBD seeds legal in Australia?', a: 'Cannabis seeds are sold as adult novelty items. CBD products have gained increasing legal recognition in Australia, with low-dose CBD available over the counter from pharmacies since 2021. However, growing laws vary by state and territory. Check your local regulations before germinating any cannabis seeds.' },
      ...
      { q: 'What is the entourage effect?', a: "The entourage effect is the synergistic interaction between cannabinoids (CBD, THC, CBG, CBN) and terpenes in cannabis. When consumed together, these compounds enhance each other's therapeutic benefits. This is why full-spectrum CBD strains are often preferred over isolated CBD." },
    ],
  },
  'high-tch-seeds': {
    h1: 'High THC Cannabis Seeds Australia — 25%+ Maximum Potency Strains',
    intro: 'High THC cannabis seeds are bred for maximum potency, producing strains with 25% THC and above. These genetics are designed for experienced cultivators and consumers who appreciate intense euphoria, deep relaxation, and powerful therapeutic effects. Our high-potency collection features legendary strains like Gorilla Glue, Bruce Banner, and Girl Scout Cookies, all available with discreet Australian shipping and our 95% germination guarantee.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Growing Tips for Maximum THC Production', content: 'Genetics determine the ceiling, but growing conditions determine how close you get. Maximise light intensity — high THC strains need strong lighting (600+ PPFD during flower). Keep temperatures at 24-28\u00B0C during flower for optimal terpene and cannabinoid production. Reduce humidity to 40% during the last 2 weeks to stress trichomes into producing more resin. Flush with plain water the final week. Harvest when trichomes are 70-80% cloudy for peak THC content. Proper drying and curing preserve potency.' },
    ],
    faqs: [
      ...
      { q: 'Do high THC strains yield less than lower THC strains?', a: 'Not as a rule. Many high-THC strains like Gorilla Glue and Bruce Banner are also excellent yielders. However, some ultra-potent boutique genetics do prioritise potency over yield. Check individual strain descriptions for yield expectations.' },
      { q: 'How do I maximise THC in my grow?', a: 'Use intense lighting (LED or HPS), maintain optimal temperature (24-28\u00B0C during flower), reduce humidity in late flower, and harvest at peak trichome maturity (mostly cloudy). Proper slow-drying and curing also preserve maximum THC content.' },
  ...
  'kush-seeds': {
    ...
    bottomSections: [
      { title: 'The Legacy of Kush Cannabis Genetics', content: 'Kush strains trace their lineage to the Hindu Kush mountain range spanning Afghanistan and Pakistan. These landraces developed natural resistance to harsh conditions — cold nights, dry air, and poor soil — producing compact plants with dense, resinous flowers. Modern kush genetics including OG Kush, Bubba Kush, Master Kush, and Purple Kush carry these hardy traits while delivering the earthy, piney, and citrusy terpene profiles that defined cannabis culture and influenced virtually every modern strain.' },
      { title: 'Best Kush Strains for Australian Growers', content: 'Our kush collection features OG Kush (the iconic legend), Bubba Kush (heavy indica relaxation), Purple Kush (stunning purple colours), Master Kush (Amsterdam Coffee Shop Cup winner), and Hindu Kush (pure landrace). For a modern twist, Skywalker Kush, Critical Kush, and Vanilla Kush offer updated terpene profiles while maintaining classic kush characteristics. Each delivers the signature dense, frosty bud structure kush is famous for.' },
      { title: 'How to Choose the Right Kush Strain', content: 'Classic kush strains are predominantly indica and deliver heavy body relaxation. For the most sedating experience, choose Bubba Kush or Hindu Kush. For balanced effects, OG Kush is the iconic choice. For visual appeal, Purple Kush develops deep purple colouring. For yield, Critical Kush and Master Kush are heavy producers. Consider growing difficulty — most kush strains are beginner to intermediate friendly.' },
    ...
    faqs: [
      ...
      { q: 'What is the difference between OG Kush and other kush strains?', a: 'OG Kush is a specific strain that originated in California in the 1990s. It has a distinct lemon-pine-fuel terpene profile. Other kush strains like Bubba Kush, Master Kush, and Hindu Kush have different lineages and flavour profiles but share kush ancestry.' },
  ...
  'mix-packs': {
    h1: 'Cannabis Seed Mix Packs Australia — Try Multiple Strains at a Discount',
    intro: 'Cannabis seed mix packs let you sample multiple strains in a single order at a discounted price. Each pack is curated to offer variety in effects, flavours, and growing characteristics. Perfect for growers who want to explore different genetics without committing to a single strain — and ideal for beginners who want to discover what they enjoy growing most.',
    quickFacts: [
  ...
  'best-seller': {
    h1: 'Best Selling Cannabis Seeds Australia — Most Popular Strains',
    intro: 'Browse our best-selling cannabis seeds — the strains Australian growers order most. These popular genetics have earned their reputation through consistent performance, reliable germination, outstanding yields, and excellent customer reviews. From classic favourites like OG Kush and Northern Lights to modern hits like Gelato and Wedding Cake, these are the proven winners from our catalogue of 1,600+ strains.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'Why Choose Best-Selling Cannabis Seeds?', content: 'Best sellers become best sellers for a reason. These strains have been grown by thousands of cultivators and consistently deliver on their promises — reliable germination, predictable growth, and excellent results. When you choose a best-selling strain, you benefit from the collective experience of the growing community. There are abundant grow journals, feeding schedules, and troubleshooting advice available for popular strains, making them easier to grow successfully.' },
      { title: 'Top Best-Selling Strains at Royal King Seeds', content: 'Our consistently top-selling strains include Gorilla Glue (extreme potency and yield), Girl Scout Cookies (iconic hybrid flavour), Blue Dream (beginner-friendly balance), Northern Lights (the easiest indoor strain), Wedding Cake (sweet flavour and high THC), OG Kush (iconic classic), Gelato (exotic dessert terpenes), and White Widow (Dutch coffeeshop legend). These strains are popular across all experience levels from first-time growers to commercial cultivators.' },
      { title: 'How to Choose From Our Best Sellers', content: 'Start with your experience level. Beginners should choose Northern Lights, Blue Dream, or White Widow for their forgiving nature. Intermediate growers can explore Girl Scout Cookies, OG Kush, or Gorilla Glue for bigger yields and more complex flavours. Advanced cultivators might try Gelato, Wedding Cake, or Bruce Banner for maximum potency and terpene production. All our best sellers are available in both autoflower and feminised versions.' },
    ],
    faqs: [
      { q: 'What is the most popular cannabis seed strain?', a: 'Gorilla Glue, Girl Scout Cookies, and Blue Dream consistently rank as our top three best sellers. They offer an excellent combination of potency, yield, flavour, and growing ease that appeals to growers of all experience levels.' },
      ...
      { q: 'Are best-selling strains available as autoflowers?', a: 'Yes. Most of our best-selling strains are available in both feminised photoperiod and autoflowering versions. Autoflower versions are faster and easier to grow while maintaining the signature effects and flavours.' },
    ],
  },
  'best-strains-for-anxiety': {
    h1: 'Best Cannabis Seeds for Anxiety Relief — Calming Strains Australia',
    intro: 'These cannabis strains are selected for their calming, anxiolytic properties. Whether you prefer high-CBD varieties or balanced THC/CBD ratios, our anxiety relief collection features genetics known to help with stress, tension, and restlessness. Strains high in the terpenes linalool, myrcene, and caryophyllene are particularly effective for anxiety management. Available with discreet Australian shipping.',
    quickFacts: [
  ...
  'best-strains-for-high-yield': {
    h1: 'High Yield Cannabis Seeds Australia — Biggest Harvests Per Plant',
    intro: 'High-yield cannabis seeds are bred specifically for maximum harvest weight. Whether you grow indoors under LED or HPS lights, or outdoors in open ground, these genetics consistently produce above-average yields when given proper care. Our high-yield collection includes both autoflowering and feminised photoperiod strains selected for heavy colas, dense bud structure, and vigorous growth — perfect for growers who want the most from every square metre. Use our yield calculator to estimate your specific harvest potential.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'What Makes a Cannabis Strain High-Yield?', content: 'High-yield genetics are characterised by vigorous branching, dense flower formation, strong nutrient uptake, and robust trichome production. Strains like Big Bud, Critical Mass, and Northern Lights have been selectively bred over decades for maximum bud production. Indoor growers using training techniques like LST, ScrOG, or topping can push these strains even further — often achieving 20-40% more than untrained plants. The genetics determine the ceiling, but your growing technique determines how close you reach it.' },
      { title: 'Best High-Yield Strains for Indoor Growing', content: 'Top indoor yield champions include Big Bud Feminised (the original yield monster), Critical Mass (dense, heavy colas), Northern Lights (reliable heavy producer), White Widow (excellent yield-to-quality ratio), and Gorilla Glue (high potency AND high yield). Under optimised LED or HPS lighting with ScrOG training, these strains can produce 500-600g per square metre. Check our indoor growing guide for detailed setup instructions.' },
      { title: 'How to Choose the Right High-Yield Strain', content: 'Consider your grow space and setup. For small tents (2x2, 2x4), choose compact high-yield strains like Northern Lights or Critical. For larger spaces (4x4+), bigger strains like Big Bud and White Widow can spread out and maximise production. For outdoor growing, select strains that finish flowering before cooler weather arrives in your region. Autoflower high-yield strains are best for multiple fast harvests per year. Use our yield calculator to estimate harvest weight for your specific setup.' },
      { title: 'Indoor vs Outdoor Yield — What to Expect', content: 'Indoor high-yield strains typically produce 400-600g per square metre under optimised lighting. A well-run 4x4 tent can yield 12-24 ounces per harvest. Outdoor high-yield strains can produce 500-1000g+ per plant when given full sun, adequate space, and a long enough growing season. In Australia, the outdoor season runs from October to April, giving growers in warmer regions plenty of time for large harvests. Autoflowering high-yield strains offer a middle ground — individually smaller harvests but 3-4 cycles per year indoors, potentially matching annual outdoor yields.' },
      { title: 'Tips for Maximising Cannabis Yield', content: 'The three biggest yield factors are genetics, lighting, and training. Start with seeds bred for yield — this is the foundation. Maximise light intensity and coverage — invest in quality LED or HPS lighting. Train your plants using LST, topping, or ScrOG to create a flat, even canopy that receives uniform light. Maintain proper nutrition with emphasis on phosphorus and potassium during flowering. Control environment — VPD, temperature, and CO2 all contribute to yield. Finally, let plants finish properly — premature harvest costs you weight and potency.' },
    ],
    faqs: [
      ...
      { q: 'How do I increase my cannabis yield?', a: 'The three biggest factors are: genetics (choose strains bred for yield), lighting (maximise intensity and coverage), and training (use LST, topping, or ScrOG). Proper nutrition, VPD control, and adequate pot size also make a significant difference.' },
      { q: 'How much can I yield in a 4x4 tent?', a: 'A well-optimised 4x4 tent with LED lighting can yield 12-24 ounces per harvest using high-yield strains with training. Beginners can expect 8-16 ounces. Use our yield calculator for a personalised estimate based on your exact setup and experience level.' },
      { q: 'Are autoflowers or feminised seeds better for yield?', a: 'Feminised photoperiod plants produce larger individual harvests (2-8 oz/plant), but autoflowers allow 3-4 cycles per year indoors. Annual yield can be comparable. For maximum single-harvest weight, choose feminised. For maximum annual production, autoflowers may win.' },
  ...
  'best-strains-for-indoor-growing': {
    h1: 'Best Cannabis Seeds for Indoor Growing Australia — Compact, High-Performing Strains',
    intro: 'These cannabis strains are specifically selected for indoor growing success. Compact growth patterns, manageable heights, strong responses to training, and excellent yields under artificial lighting make these the top choices for tent and grow room cultivators across Australia. Whether you run a 2x2 micro grow or a full room setup, these genetics are optimised to thrive under LED and HPS lighting.',
    quickFacts: [
      { label: 'Plant Height', value: '2-4 Feet' },
    ...
    bottomSections: [
      ...
      { title: 'How to Choose Indoor Cannabis Seeds', content: 'Start with your tent size and height. If you have limited vertical space, choose indica-dominant or autoflower strains. Consider your lighting — higher-wattage setups support more plants and taller strains. Think about turnaround time: autoflowers finish fastest (8-10 weeks) while photoperiod sativas take longest (14-16 weeks total). For beginners, autoflower indicas are the easiest indoor option. For maximum yield, trained feminised indicas and hybrids deliver the best per-square-metre returns.' },
      ...
      { title: 'Indoor Growing Tips for Maximum Results', content: 'Invest in quality lighting — this is the single most impactful equipment decision. Maintain VPD (vapour pressure deficit) in the optimal range for each growth stage. Use carbon filters for odour control. Train plants early and consistently for even canopy development. Monitor pH and EC of your nutrient solution. Keep good airflow to prevent mould and strengthen stems. Check our complete indoor grow guide for detailed setup instructions and feeding schedules.' },
    ],
    faqs: [
      ...
      { q: 'Do I need a carbon filter for indoor growing?', a: 'Yes, strongly recommended. Cannabis produces strong odours during flowering. A carbon filter connected to your exhaust fan eliminates 99% of smell. This is essential for discreet indoor growing and maintaining good relations with neighbours.' },
    ],
  },
  'best-strains-for-outdoor-growing': {
    h1: 'Best Cannabis Seeds for Outdoor Growing Australia — Weather-Resistant Strains',
    intro: 'These cannabis strains are specifically selected for outdoor growing success across Australia. Whether you are cultivating in the tropical north of Queensland, the temperate climates of Victoria and New South Wales, or the dry heat of Western Australia, these weather-resistant genetics deliver reliable outdoor harvests. Outdoor growing offers the highest yield potential per plant — some strains produce over a pound per plant in optimal conditions. Browse our outdoor-optimised collection.',
    quickFacts: [
      { label: 'Yield Per Plant', value: '8-32+ oz' },
      { label: 'Harvest Time', value: 'Mar-May (Australia)' },
      { label: 'Light Source', value: 'Free Sunlight' },
      { label: 'Best For', value: 'Maximum Plant Size' },
    ],
    bottomSections: [
      { title: 'What Makes a Good Outdoor Cannabis Strain?', content: 'Successful outdoor strains share several traits: natural pest and mould resistance, tolerance to temperature fluctuations, ability to handle wind and rain, and finishing times that align with your local growing season. In Australia, the outdoor growing season runs from October to April (Southern Hemisphere spring through autumn). Sativa-dominant strains thrive in tropical and subtropical regions like Queensland and the Northern Territory, while indica-dominant and hybrid strains work well in cooler southern climates. Autoflower strains are the safest outdoor bet in any Australian climate due to their fast finish times.' },
      { title: 'Best Outdoor Strains by Australian Region', content: 'Queensland and Northern Territory (tropical, warm): most strains thrive here — try Sour Diesel, Jack Herer, or any high-yield sativa. New South Wales and Victoria (temperate): Northern Lights, White Widow, Blue Dream, and mould-resistant hybrids. South Australia and Western Australia (hot, dry): virtually any strain works in these conditions with adequate water. Tasmania (cool, short season): fast-finishing strains, autoflowers, and mould-resistant indicas like Critical Mass. For all regions, autoflowers are the safest choice to guarantee a harvest before cooler weather arrives.' },
      { title: 'How to Choose Outdoor Cannabis Seeds for Australia', content: 'Your number one consideration is your local climate and season length. The Australian outdoor season starts in October (spring) and harvests occur from March to May (autumn). Count the weeks of warm weather available — this is your outdoor growing window. Photoperiod strains need adequate warmth through to late autumn. Autoflowers need only 10-12 weeks, making them viable almost anywhere in Australia. Consider humidity — if your autumn is wet, choose mould-resistant strains or fast finishers. Consider security — shorter, bushier plants are less visible than tall sativas.' },
      ...
      { title: 'Outdoor Growing Tips for Australian Growers', content: 'Start seeds indoors in early spring (September) and transplant outdoors after the risk of frost has passed (October in most regions). Choose a north-facing location with maximum sun exposure (north-facing in the Southern Hemisphere gets the most light). Prepare soil with compost and amendments before planting. Use fabric pots or raised beds for better root aeration. Protect young plants from animals and pests. Monitor for mould starting in late summer as humidity rises. Harvest when trichomes are cloudy — do not wait for amber if rain is forecast. Check our outdoor growing guide for region-specific advice.' },
    ],
    faqs: [
      { q: 'When should I plant cannabis outdoors in Australia?', a: 'Most Australian growers start seeds indoors in September and transplant outdoors in October, after the last frost risk. Autoflowering strains can be planted later since they finish faster. Harvest typically occurs between March and May depending on strain and location.' },
      { q: 'What is the best outdoor cannabis strain for Australia?', a: 'Blue Dream, Northern Lights, and Sour Diesel are consistently top-rated outdoor strains. Blue Dream offers balanced effects with mould resistance. Northern Lights finishes fast for southern growers. Sour Diesel thrives in warm climates with huge yields.' },
      { q: 'How much does an outdoor cannabis plant yield?', a: 'Outdoor yields range widely: 8-32+ ounces per plant depending on strain, climate, and growing technique. In ideal conditions (Queensland, Northern Territory, Western Australia), experienced growers regularly achieve 2+ pounds per plant with high-yield genetics.' },
      { q: 'Can I grow cannabis outdoors in cooler climates like Tasmania?', a: 'Yes, but choose fast-finishing strains or autoflowers. Northern Lights, Early Girl, and auto strains finish before the cold weather arrives. Start seeds indoors and transplant out after the last frost to maximise your growing season.' },
      { q: 'How do I protect outdoor plants from mould?', a: 'Choose mould-resistant strains, improve airflow by spacing plants well, shake water off buds after rain, and harvest promptly if conditions deteriorate. Avoid dense indica strains in humid climates — open bud structures resist mould better.' },
      { q: 'Do I need to water outdoor cannabis plants?', a: 'Yes, especially during the hot Australian summer months. Outdoor plants in the ground need 4-12 litres per day in peak summer. Container plants need more frequent watering. Mulching helps retain soil moisture. Water early morning or evening to reduce evaporation.' },
    ],
  },
  'fast-flowering-seeds': {
    h1: 'Fast Flowering Cannabis Seeds Australia — Quick Harvest Strains',
    intro: 'Fast flowering cannabis seeds combine photoperiod genetics with accelerated flowering times, typically finishing 1-2 weeks earlier than standard strains. Ideal for outdoor growers in cooler Australian regions who need to harvest before autumn weather turns, and indoor growers who want faster turnaround between cycles. These strains maintain the potency and yield of standard photoperiod genetics while shaving critical weeks off the flowering timeline.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'How to Choose Fast Flowering Seeds', content: 'Consider whether you need a full photoperiod plant (with veg control) that flowers quickly, or if a standard autoflower would serve your needs. Fast-flowering photoperiod strains give you the advantage of controlling plant size during veg while still getting a faster harvest. Compare flowering times between fast and standard versions of the same strain. For outdoor growers, calculate whether the fast version will finish before cooler autumn weather arrives in your area.' },
    ],
    faqs: [
      { q: 'How fast do fast flowering seeds finish?', a: 'Fast flowering strains typically finish flowering in 6-8 weeks compared to 8-11 weeks for standard versions. This 1-2 week advantage can be critical for outdoor growers who need to harvest before cooler weather arrives.' },
      ...
      { q: 'Who should use fast flowering seeds?', a: 'Fast flowering seeds are ideal for outdoor growers in cooler Australian regions with shorter warm seasons, indoor growers wanting more harvest cycles per year, and anyone who needs a quick turnaround without switching to autoflowers.' },
    ],
  },
  'photoperiod': {
    h1: 'Photoperiod Cannabis Seeds Australia — Light-Dependent Flowering Strains',
    intro: 'Photoperiod cannabis seeds require a change in light cycle to trigger flowering, giving experienced growers full control over vegetative growth and harvest timing. These strains include the most potent, highest-yielding, and most flavourful genetics in our catalogue. Photoperiod growing allows you to train, clone, and manipulate plants for maximum results — making these seeds the choice of serious cultivators.',
    quickFacts: [
    ...
    faqs: [
      ...
      { q: 'Can beginners grow photoperiod seeds?', a: 'Yes, but autoflowers are easier for absolute beginners. Photoperiod growing requires understanding light cycles, recognising when to flip, and more environmental control. After one autoflower grow, most growers are ready for photoperiod.' },
  ...
  'exotic-cannabis-seeds': {
    h1: 'Exotic Cannabis Seeds Australia — Rare & Unique Genetics',
    intro: 'Exotic cannabis seeds feature rare, unique genetics bred for standout terpene profiles, unusual colours, and exceptional potency. These are the strains that push the boundaries of what cannabis can offer — from Zkittlez and Gelato to Runtz and Mimosa. If you want something special that stands out from the classics, our exotic collection delivers the most interesting and sought-after genetics available.',
    quickFacts: [
      { label: 'Terpenes', value: 'Unique & Complex' },
      { label: 'THC Range', value: '20-30%+' },
      { label: 'Visual Appeal', value: 'Stunning Colours' },
      { label: 'Best For', value: 'Flavour Hunters' },
    ],
    bottomSections: [
      { title: 'What Makes a Cannabis Strain Exotic?', content: 'Exotic strains are defined by their unique characteristics — unusual terpene profiles, striking visual appearance, or novel genetic combinations. Strains like Gelato, Runtz, and Wedding Cake became "exotic" because they offered flavour and potency profiles unlike anything that came before them. Modern exotic genetics push boundaries with candy-sweet terpenes, vivid purple colouring, and THC levels exceeding 30%. They represent the cutting edge of cannabis breeding.' },
      { title: 'Best Exotic Strains in Our Collection', content: 'Our exotic collection features Gelato (dessert cream terpenes), Zkittlez (candy fruit explosion), Runtz (sweet and potent), Wedding Cake (vanilla and dough), Mimosa (citrus champagne), Biscotti (cookie and gas), Gary Payton (exclusive collab genetics), and Ice Cream Cake (sweet and sedating). These strains are popular worldwide and are now available as seeds for home cultivation.' },
      { title: 'Growing Tips for Exotic Strains', content: 'Exotic genetics can be more sensitive to growing conditions than classic strains. Maintain precise environmental control — temperature, humidity, and pH fluctuations can stress these plants more than hardy classics. Feed carefully and avoid heavy nutrient regimens. Many exotics respond best to organic growing methods that enhance terpene expression. Lower temperatures during late flowering can bring out purple and dark colouring. Proper slow drying and extended curing are essential to preserve the complex terpene profiles that make exotics special.' },
    ],
    faqs: [
      { q: 'What are exotic cannabis strains?', a: 'Exotic strains are rare or unique genetics known for exceptional terpene profiles, visual appeal, and potency. Strains like Gelato, Runtz, and Zkittlez are considered exotic due to their candy-like flavours, vivid colours, and high THC levels that distinguish them from classic genetics.' },
      ...
      { q: 'Why are exotic seeds more expensive?', a: 'Exotic genetics represent significant breeding investment — creating stable, unique terpene profiles takes years of selection. Limited availability, high demand, and premium genetics justify the higher price. The unique flavours and effects justify the investment for many growers.' },
    ],
  },
  'classic-cannabis-seeds': {
    h1: 'Classic Cannabis Seeds Australia — Timeless Genetics & Heritage Strains',
    intro: 'Classic cannabis seeds bring you the heritage genetics that defined cannabis culture. From White Widow and Northern Lights to Skunk #1 and AK-47, these time-tested strains offer proven performance, reliable genetics, and the authentic flavours that experienced growers love. Classics are called classics for a reason — decades of growing data, breeding refinement, and community knowledge make them the most reliable seeds you can plant.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Top Classic Strains for Australian Growers', content: 'Our classic collection features Northern Lights (the easiest strain to grow, period), White Widow (Dutch coffeeshop legend), OG Kush (iconic classic), AK-47 (one-hit wonder), Skunk #1 (the backbone of modern breeding), Amnesia Haze (cerebral powerhouse), Blue Dream (balanced favourite), Sour Diesel (high-energy sativa), and Jack Herer (named after the cannabis activist). Each has decades of proven performance behind it.' },
    ],
    faqs: [
      ...
      { q: 'Are classic strains as potent as modern strains?', a: 'Many classics have been updated with modern breeding to increase potency. OG Kush, Gorilla Glue, and Girl Scout Cookies regularly test above 25% THC. Some vintage classics like Skunk #1 have lower THC but offer unique effects and flavours not found in modern genetics.' },
    ],
  },
  'fruity-cannabis-seeds': {
    h1: 'Fruity Cannabis Seeds Australia — Sweet & Tropical Flavour Genetics',
    intro: 'Fruity cannabis seeds produce strains bursting with sweet, tropical, and berry-forward terpene profiles. If you love strains that taste like blueberry, mango, strawberry, citrus, or tropical punch, this collection is curated for flavour-focused Australian growers. Fruity terpene profiles are dominated by limonene, myrcene, and terpinolene — the same compounds found in fruits — creating genuinely delicious smoking and vaping experiences.',
    quickFacts: [
      { label: 'Key Terpenes', value: 'Limonene & Myrcene' },
      { label: 'Flavours', value: 'Berry, Citrus, Tropical' },
      { label: 'Effects', value: 'Uplifting & Happy' },
      { label: 'Best For', value: 'Flavour Lovers' },
    ],
    bottomSections: [
      { title: 'What Makes Cannabis Taste Fruity?', content: 'Fruity flavours in cannabis come from specific terpene combinations. Limonene creates citrus notes (lemon, orange, grapefruit). Myrcene contributes mango and tropical flavours. Linalool adds floral berry notes. Terpinolene creates piney-fruity complexity. When these terpenes combine in high concentrations, the result is strains that genuinely taste and smell like fresh fruit. Modern breeding has pushed fruity terpene production to levels that rival actual fruit aromatics.' },
      { title: 'Best Fruity Cannabis Strains', content: 'Our fruity collection features Blueberry (the original berry strain), Strawberry Cough (sweet strawberry with energising effects), Pineapple Express (tropical citrus hybrid), Tangie (tangerine heaven), Zkittlez (candy fruit explosion), Forbidden Fruit (cherry and citrus), Mango Kush (tropical indica), and Grape Ape (grape-forward relaxation). Each delivers genuine fruit flavours alongside quality effects and yields.' },
      { title: 'How to Maximise Fruity Terpene Production', content: 'Terpene production is maximised through specific growing techniques. Lower temperatures during the last 2 weeks of flowering encourage terpene preservation. Organic growing methods — especially living soil and compost teas — tend to produce richer terpene profiles than synthetic nutrients. Avoid heat stress, which degrades terpenes. Slow dry at 15\u00B0C and 60% humidity for 10-14 days. Cure in glass jars for a minimum of 2 weeks (4+ weeks is better). Proper post-harvest handling is critical for preserving fruity flavours.' },
    ],
    faqs: [
      { q: 'What is the best fruity cannabis strain?', a: 'Blueberry, Zkittlez, and Pineapple Express are consistently rated the best fruity strains. Blueberry delivers classic berry flavour, Zkittlez tastes like candy, and Pineapple Express offers tropical citrus. Each provides a genuinely delicious experience.' },
      { q: 'Do fruity strains taste like actual fruit?', a: 'The best fruity strains produce remarkably authentic fruit flavours and aromas. This comes from high concentrations of the same terpenes found in actual fruits — limonene, myrcene, and linalool. When grown and cured properly, many people cannot distinguish the aroma from real fruit.' },
      { q: 'Are fruity strains potent?', a: 'Yes. Fruity terpene profiles are independent of THC content. Many fruity strains like Zkittlez (20-25% THC), Forbidden Fruit (24-26% THC), and Tangie (19-22% THC) deliver excellent potency alongside their flavour.' },
    ],
  },
  'purple-genetics-seeds': {
    h1: 'Purple Cannabis Seeds Australia — Stunning Purple Genetics',
    intro: 'Purple cannabis seeds produce plants with striking purple, violet, and dark colouration in their flowers and foliage. Beyond their visual appeal, purple strains often deliver unique terpene profiles with grape, berry, and floral notes. The purple colouring comes from anthocyanin pigments that develop when temperatures drop during late flowering. Browse our collection of the most visually stunning cannabis genetics available.',
    quickFacts: [
      { label: 'Colour', value: 'Purple, Violet, Dark' },
      { label: 'Pigment', value: 'Anthocyanins' },
      { label: 'Flavours', value: 'Grape, Berry, Floral' },
      { label: 'Best For', value: 'Bag Appeal & Flavour' },
    ],
    bottomSections: [
      { title: 'What Makes Cannabis Turn Purple?', content: 'Purple colouring in cannabis is caused by anthocyanin pigments — the same compounds that make blueberries blue and grapes purple. Some strains carry genetic predispositions for high anthocyanin production. Cold temperatures during late flowering (15-18\u00B0C at night) trigger and intensify purple colouring. However, the genetics must be present — you cannot turn a non-purple strain purple just by lowering temperatures. Our purple genetics collection features strains bred specifically for dramatic colour expression.' },
      { title: 'Best Purple Cannabis Strains', content: 'Our purple collection features Granddaddy Purple (the purple strain standard), Purple Punch (grape candy flavour), Purple Haze (Hendrix-inspired sativa), Purple Kush (pure indica relaxation), Tropicana Purple (citrus meets purple), and Forbidden Fruit (deep purple with cherry notes). Each produces stunning visual appeal alongside excellent effects and yield when grown properly.' },
    ],
    faqs: [
      { q: 'Are purple strains more potent?', a: 'Purple colouring is independent of potency. Some purple strains are very potent (Granddaddy Purple at 20-27% THC), while others are moderate. The purple colour comes from anthocyanin pigments, not cannabinoids. Choose purple strains for their unique flavours and visual appeal.' },
      { q: 'How do I make my cannabis plants turn purple?', a: 'You need genetics that carry anthocyanin genes. Then lower nighttime temperatures to 15-18\u00B0C during the last 2-3 weeks of flowering. You cannot make a non-purple strain turn purple. All strains in our purple collection carry these genetics.' },
      { q: 'Do purple strains taste different?', a: 'Yes. Purple strains often have grape, berry, and floral terpene profiles that differ from green strains. The unique terpene combinations create flavours reminiscent of grape candy, berries, and wine. These flavours are one of the main reasons growers seek out purple genetics.' },
    ],
  },
  'euphoric-seeds': {
    h1: 'Euphoric Cannabis Seeds Australia — Mood-Elevating Happiness Strains',
    ...
    bottomSections: [
      ...
      { title: 'Best Euphoric Cannabis Strains', content: 'Our top euphoric strains include Wedding Cake (euphoric bliss), Girl Scout Cookies (happy and creative), Jack Herer (clear-headed euphoria), Blue Dream (gentle elation), Green Crack (energising happiness), and Super Lemon Haze (citrus-powered mood boost). These strains consistently produce positive, uplifting mental states that enhance social interactions, creative activities, and overall well-being.' },
    ],
    faqs: [
      ...
      { q: 'Are euphoric strains good for social situations?', a: 'Yes. Euphoric strains are specifically chosen for social enhancement. They promote happiness, talkativeness, giggly behaviour, and positive mental states. Sativa-dominant and balanced hybrids are best for social settings.' },
    ],
  },
  'energizing-cannabis-seeds': {
    h1: 'Energising Cannabis Seeds Australia — Stimulating Daytime Strains',
    intro: 'Energising cannabis seeds produce strains that boost energy, mental clarity, and motivation without the sedative effects of heavy indicas. Perfect for daytime use, creative projects, social gatherings, and active lifestyles. These sativa-dominant genetics deliver clean stimulation that helps you stay productive and engaged throughout the day.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'What Makes Cannabis Energising?', content: 'Energising effects come primarily from sativa genetics combined with specific terpene profiles. Terpinolene and limonene are the key terpenes associated with energy and mental stimulation. Some energising strains also contain notable THCV levels — a cannabinoid known for its stimulating, appetite-suppressing properties. The best energising strains provide clean mental clarity without the jittery feeling of caffeine or the crash that comes with stimulant supplements.' },
      { title: 'Best Energising Cannabis Strains', content: 'Our top energising strains include Sour Diesel (intense fuel-powered energy), Green Crack (focused stimulation), Jack Herer (clear-headed motivation), Durban Poison (pure African sativa energy), Super Lemon Haze (citrus-powered uplift), and Tangie (tangerine-flavoured focus). These strains are popular among creative professionals, athletes, and anyone who wants productive cannabis without sedation.' },
    ],
    faqs: [
      { q: 'What is the most energising cannabis strain?', a: 'Sour Diesel, Green Crack, and Durban Poison are consistently rated as the most energising cannabis strains. They deliver clean, focused energy without anxiety or sedation. Sativa-dominant genetics with high terpinolene content produce the best energy effects.' },
      { q: 'Can energising strains replace coffee?', a: 'Many cannabis users use energising sativa strains as a morning or mid-day boost alongside or instead of coffee. While the stimulation mechanisms are different, clean sativa energy can provide focus and motivation without caffeine jitters or afternoon crashes.' },
    ],
  },
  'bogo-seeds': {
    h1: 'BOGO Cannabis Seeds Australia — Buy One Get One Free Deals',
  ...
  'australian-premium-cannabis-seeds': {
    h1: 'Australian Premium Cannabis Seeds — Hand-Selected Genetics for Australian Growers',
    intro: 'Our Australian Premium collection features hand-selected cannabis seeds specifically chosen for the Australian market. These genetics are tested for performance in Australian growing conditions — hot summers, mild winters, variable humidity, and diverse environments from the tropical north to the temperate south. Premium selection means top-tier potency, yields, and reliability.',
    quickFacts: [
      { label: 'Selection', value: 'Hand-Picked' },
      { label: 'Testing', value: 'Australian Climate Tested' },
      { label: 'Potency', value: 'Premium THC Levels' },
      { label: 'Best For', value: 'Australian Growers' },
    ],
    bottomSections: [
      { title: 'What Makes Our Premium Collection Special?', content: "Every strain in our Australian Premium collection has been evaluated for performance in Australian growing conditions. We consider climate adaptability (handles heat, humidity, and seasonal changes), pest resistance, yield consistency, and potency reliability. These are not random selections — they are curated based on customer feedback from 200,000+ growers worldwide, ensuring every seed in this collection has a proven track record of success across diverse growing environments including Australia's unique climate zones." },
    ],
    faqs: [
      { q: 'What makes premium seeds different from standard seeds?', a: 'Premium seeds are hand-selected from top-performing genetics specifically tested for Australian growing conditions. They represent our highest-confidence strains for Australian growers — proven reliability, potency, and yield across diverse climates.' },
    ],
  },
  'ruderalis': {
    h1: 'Ruderalis Cannabis Seeds Australia — Wild Cannabis Genetics',
    intro: 'Ruderalis is the wild ancestor of autoflowering cannabis. Originating from Central Russia and Central Asia, these genetics carry the autoflowering trait that modern breeders have incorporated into popular strains. Pure ruderalis strains are compact, hardy, and flower based on age rather than light — the foundation of every autoflower in our catalogue.',
    quickFacts: [
  ...
  'feminized-hybrids': {
    h1: 'Feminised Hybrid Cannabis Seeds Australia — Best of Both Worlds',
    intro: 'Feminised hybrid seeds combine indica and sativa genetics in guaranteed female plants. Get balanced effects, versatile growing characteristics, and no males to remove. Our feminised hybrid collection features the most popular balanced strains available, from Girl Scout Cookies to Gorilla Glue.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'Why Choose Feminised Hybrids?', content: 'Feminised hybrid seeds give you the widest range of effects, flavours, and growing characteristics in guaranteed female plants. Hybrids combine indica body effects with sativa mental stimulation, and feminisation ensures every seed produces a harvestable plant. This is the most popular category among experienced growers who want versatile strains that perform well in any environment.' },
    ],
    faqs: [
      { q: 'What are feminised hybrid seeds?', a: 'Feminised hybrid seeds are crosses between indica and sativa genetics that produce 99.9% female plants. They offer balanced effects, versatile growing profiles, and the guarantee that every seed becomes a bud-producing plant.' },
    ],
  },
  'feminized-indicas': {
    h1: 'Feminised Indica Cannabis Seeds Australia — Relaxing Female Plants',
    intro: 'Feminised indica seeds deliver deep relaxation, pain relief, and sleep support in guaranteed female plants. Compact growth, fast flowering times, and dense buds make these the ideal choice for indoor growers seeking indica effects without the hassle of identifying plant sex.',
    quickFacts: [
      { label: 'Sex', value: '99.9% Female' },
      { label: 'Effects', value: 'Relaxing & Sedating' },
    ...
    bottomSections: [
      { title: 'Why Choose Feminised Indica Seeds?', content: 'Feminised indicas are the easiest indoor cannabis to grow. They stay naturally compact, produce dense resinous buds in 7-9 weeks of flowering, and every seed is guaranteed female. This means no wasted space on male plants and no risk of accidental pollination. Popular feminised indicas include Northern Lights, Granddaddy Purple, Bubba Kush, and Hindu Kush — all proven performers for indoor tent cultivation.' },
    ],
    faqs: [
      { q: 'Are feminised indica seeds good for beginners?', a: 'Yes. Feminised indicas are arguably the easiest cannabis to grow. They stay compact, flower fast, tolerate growing mistakes, and produce reliably without needing to identify and remove male plants. Northern Lights Feminised is the gold standard for beginners.' },
    ],
  },
  'feminized-sativas': {
    h1: 'Feminised Sativa Cannabis Seeds Australia — Energising Female Plants',
    intro: 'Feminised sativa seeds deliver cerebral energy, creativity, and uplifting effects in guaranteed female plants. These genetics offer the signature sativa experience with the convenience of all-female growing. Browse sativa-dominant feminised strains from classic Haze varieties to modern sativa hybrids.',
    quickFacts: [
      { label: 'Sex', value: '99.9% Female' },
      { label: 'Effects', value: 'Energising & Creative' },
    ...
    bottomSections: [
      { title: 'Why Choose Feminised Sativa Seeds?', content: 'Feminised sativas offer the full cerebral experience of sativa genetics with guaranteed female plants. Since sativas take longer to flower (10-12 weeks), feminisation is especially valuable — you do not want to discover males after investing months of veg time. Popular feminised sativas include Jack Herer, Sour Diesel, Amnesia Haze, and Super Lemon Haze. Indoor growers should plan for height management through training techniques.' },
    ],
    faqs: [
      { q: 'Can I grow feminised sativas indoors?', a: 'Yes, with proper height management. Use topping, LST, and ScrOG techniques to control the natural height of sativa plants. Flip to 12/12 earlier than you would with indicas to account for the sativa flowering stretch.' },
    ],
  },
  'auto-flowering-hybrids': {
    h1: 'Autoflowering Hybrid Cannabis Seeds Australia — Fast Balanced Genetics',
  ...
  'auto-flowering-indicas': {
    h1: 'Autoflowering Indica Cannabis Seeds Australia — Fast Relaxation',
  ...
  'auto-flowering-sativas': {
    h1: 'Autoflowering Sativa Cannabis Seeds Australia — Fast Energy',
    intro: 'Autoflowering sativa seeds deliver the cerebral energy and creativity of sativa genetics in a fast, compact, automatically flowering package. Enjoy uplifting daytime effects without the tall growth and long flowering times of photoperiod sativas. Harvest energising buds in 9-11 weeks from seed.',
    quickFacts: [
      { label: 'Flowering', value: 'Automatic' },
  ...
  'growers-choice-seeds-collection': {
    ...
    bottomSections: [
      { title: "How We Choose Our Grower's Choice Picks", content: "Our cultivation team evaluates every strain in our catalogue based on germination reliability, growth vigour, yield consistency, terpene quality, potency, and overall growing experience. Strains that excel across all metrics earn a spot in the Grower's Choice collection. These are the genetics we confidently recommend to any grower, regardless of experience level. We update this collection regularly based on new strain releases and ongoing customer feedback from growers across Australia and worldwide." },
    ],
    faqs: [
      { q: "What makes Grower's Choice strains special?", a: "These strains are hand-selected by our cultivation team based on all-around excellence: germination rate, growth vigour, yield, potency, and terpene quality. They represent our highest-confidence recommendations for Australian growers at any experience level." },
    ],
  },
};
