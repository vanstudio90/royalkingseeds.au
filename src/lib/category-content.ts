...
export const categoryContent: Record<string, CategoryContent> = {
  'shop-all-cannabis-seeds': {
    ...
    intro: 'Royal King Seeds is your trusted Australian source for premium cannabis seeds. Browse our complete collection of over 1,600 feminized, autoflowering, indica, sativa, hybrid, and CBD strains with discreet shipping to all states and territories. Every seed order includes our 95% germination guarantee, competitive pricing, and expert growing support for cultivators of all experience levels across Australia. Whether you are a first-time grower starting with easy autoflowers or an experienced cultivator chasing maximum potency, our catalog has the right genetics for your goals. Use our strain finder quiz to get personalised recommendations or explore our yield calculator to estimate your harvest.',
    quickFacts: [
    ...
    bottomSections: [
      { title: 'Why Buy Cannabis Seeds From Royal King Seeds?', content: 'Royal King Seeds combines an extensive seed catalog with genuine customer care that sets us apart from other Australian seed banks. Our genetics are sourced from reputable breeders worldwide, stored in climate-controlled conditions, and shipped in protective packaging to maintain viability. Australian growers trust us because we deliver consistent results, transparent strain information, and responsive support that helps you succeed from germination through harvest. With over 200,000 orders fulfilled since 2019, we have the track record to back our promises.' },
      { title: 'Cannabis Seed Types Available for Australian Growers', content: 'Our catalog includes feminized cannabis seeds (guaranteed 99.9% female plants), autoflowering seeds (flower automatically in 8-10 weeks), CBD-rich varieties for therapeutic growers, high-THC strains for experienced cultivators, and curated mix packs for those who want variety. Whether you are growing indoors in a small flat in Sydney or outdoors in the Queensland sun, we have genetics suited to your environment and goals. Use our yield calculator to estimate your harvest based on your specific setup.' },
      ...
      { title: 'Tips for Growing Cannabis Seeds Successfully', content: 'Start with quality genetics — strain selection is the single biggest factor in your results. Germinate seeds using the paper towel method or direct soil planting. Maintain proper temperature (21-29°C), humidity (40-60% during flower), and pH (6.0-6.5 in soil). Use quality lighting — LED or HPS for indoor grows. Feed conservatively and increase gradually. Train your plants with LST or topping for bigger yields. Check our complete grow guide library for detailed instructions on every stage from seed to harvest.' },
    ],
    faqs: [
      { q: 'Is it legal to buy cannabis seeds in Australia?', a: 'Cannabis seeds are sold as adult novelty souvenirs and for genetic preservation. Laws regarding germination vary by state and territory. Buyers are responsible for understanding local regulations. The ACT permits limited personal cultivation for adults, and laws continue to evolve across other states and territories.' },
      { q: 'How do I choose the right cannabis seeds?', a: 'Consider your growing environment (indoor vs outdoor), experience level, desired effects, and climate. Beginners should start with autoflowering or feminized seeds. Take our strain finder quiz for personalised recommendations based on your specific needs.' },
      ...
      { q: 'How long does shipping take?', a: 'Orders ship within 1-2 business days. Most Australian deliveries arrive in 3-7 business days via Australia Post. All orders ship in plain, unmarked packaging for complete discretion. Free shipping on orders over $150.' },
      ...
      { q: 'Do you ship to all states and territories?', a: 'Yes. We ship cannabis seeds to all Australian states and territories using plain, unmarked packaging. Every order includes tracking information. Free shipping is available on orders over $150 AUD.' },
    ],
  },
  'feminized-seeds': {
    h1: 'Feminized Cannabis Seeds Australia — Guaranteed 99.9% Female Plants',
    intro: 'Shop the largest selection of feminized cannabis seeds available online in Australia. Feminized seeds are genetically engineered to produce 99.9% female plants, eliminating the need to identify and remove males. This means every seed you plant has the potential to produce harvestable, cannabinoid-rich flowers. Browse indica-dominant, sativa-dominant, and hybrid feminized genetics — from classic strains like OG Kush and White Widow to modern favourites like Gelato and Wedding Cake. All with discreet Australia-wide shipping and our 95% germination guarantee.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Feminized vs Autoflower Seeds — Which Is Better?', content: 'Feminized photoperiod seeds give you more control. You decide when to flip to flower by changing the light cycle, allowing you to grow plants as large as you want during veg. This means higher yields per plant — typically 60-230g indoor. Autoflowers are faster and simpler but produce smaller individual harvests. For maximum yield per grow cycle, choose feminized. For speed and simplicity, choose autoflowers. Many experienced growers run both — autoflowers for quick harvests and feminized for their main crop.' },
    ...
    faqs: [
      ...
      { q: 'How much do feminized plants yield?', a: 'Indoor feminised plants typically yield 30-120g per plant in a standard tent setup, with trained plants reaching 120-230g. Outdoor plants can yield significantly more — 230-450+ grams per plant depending on strain and growing conditions. Use our yield calculator for personalised estimates.' },
  ...
  'autoflowering-seeds': {
    ...
    faqs: [
      ...
      { q: 'Can I grow autoflowers outdoors in Australia?', a: 'Absolutely. Autoflowers are excellent for outdoor growing in every Australian climate. They can be planted from October through January, and their short lifecycle means you can complete 2-3 outdoor harvests per season in warmer regions like Queensland and the Northern Territory.' },
      { q: 'How much do autoflowers yield?', a: 'Individual autoflower plants typically yield 30-120g depending on strain, container size, and growing conditions. Indoor growers can achieve 350-500g per square metre. The trade-off for lower per-plant yield is more harvests per year.' },
  ...
  'indica-seeds': {
    ...
    faqs: [
      ...
      { q: 'Can I grow indica seeds outdoors?', a: 'Yes. Indica strains perform well outdoors in most Australian climates. Their shorter flowering times mean they finish before autumn frosts in cooler southern regions. Indicas also handle cooler nighttime temperatures well, and some strains develop beautiful purple colouring in cold conditions.' },
      ...
      { q: 'How much do indica plants yield?', a: 'Indoor indica plants typically yield 350-500g per square metre. Individual plants produce 30-120g in standard setups, or more with training. Outdoor indica plants can yield 230-450g per plant with adequate space and sunlight.' },
    ],
  },
  'sativa-seeds': {
    h1: 'Sativa Cannabis Seeds Australia — Energizing Daytime Strains',
    intro: 'Sativa cannabis seeds produce tall, vigorous plants celebrated for their cerebral, energizing, and uplifting effects. Australian growers choose sativa genetics for creativity, focus, social enhancement, and daytime productivity. Our sativa seed collection includes classic Haze varieties, tropical landrace genetics, and modern sativa-dominant hybrids that have been bred for manageable indoor growing while retaining the signature sativa experience.',
    quickFacts: [
    ...
    bottomSections: [
      ...
      { title: 'Best Sativa Strains for Australian Growers', content: 'Our sativa collection features legendary genetics including Jack Herer (cerebral clarity), Sour Diesel (intense energy), Amnesia Haze (creative euphoria), and Super Lemon Haze (citrus-forward flavour). For indoor growers concerned about height, sativa-dominant hybrids like Blue Dream and Green Crack offer manageable growth patterns while delivering authentic sativa effects. Outdoor growers in Queensland, the Northern Territory, and other warm-climate regions can take full advantage of pure sativa genetics.' },
      { title: 'How to Choose the Right Sativa Strain', content: 'Consider your growing setup first. Pure sativas can reach 3+ metres and need tall grow spaces or outdoor gardens. Sativa-dominant hybrids (60-70% sativa) offer a compromise with shorter heights and faster flowering. For effects, choose strains based on your goals: Jack Herer for focus, Sour Diesel for energy, Amnesia Haze for creativity. Check flowering times — pure sativas can take 12-14 weeks, while hybrids finish in 9-11 weeks.' },
    ...
    faqs: [
      ...
      { q: 'Can I grow sativa seeds indoors?', a: 'Yes, but pure sativas can grow very tall (2-3+ metres). Indoor growers should choose sativa-dominant hybrids or use aggressive training techniques like topping, LST, and ScrOG to manage height. Flip to 12/12 early to control final size.' },
  ...
  'hybrid': {
    ...
    quickFacts: [
      ...
      { label: 'Plant Height', value: '90-180cm' },
    ...
    bottomSections: [
      ...
      { title: 'Best Hybrid Strains for Indoor and Outdoor Growing', content: 'Top hybrid strains include Girl Scout Cookies (euphoric and relaxing), Gorilla Glue (potent and heavy-yielding), Wedding Cake (sweet flavour with strong effects), Blue Dream (balanced and beginner-friendly), and OG Kush (the West Coast classic). Most hybrids grow to moderate heights (90-180cm) and finish flowering in 8-10 weeks, making them manageable for both indoor and outdoor cultivation across Australia.' },
  ...
  'cbd-strains': {
    ...
    faqs: [
      ...
      { q: 'Are CBD seeds legal in Australia?', a: 'Cannabis seeds are sold as adult novelty items. Laws regarding cannabis cultivation vary by state and territory across Australia. The ACT allows limited personal cultivation. Buyers are responsible for understanding their local regulations before germinating any cannabis seeds.' },
  ...
  'high-tch-seeds': {
    ...
    intro: 'High THC cannabis seeds are bred for maximum potency, producing strains with 25% THC and above. These genetics are designed for experienced cultivators and consumers who appreciate intense euphoria, deep relaxation, and powerful therapeutic effects. Our high-potency collection features legendary strains like Gorilla Glue, Bruce Banner, and Girl Scout Cookies, all available with discreet Australia-wide shipping and our 95% germination guarantee.',
    quickFacts: [
  ...
  'kush-seeds': {
    ...
    bottomSections: [
      ...
      { title: 'How to Choose the Right Kush Strain', content: 'Classic kush strains are predominantly indica and deliver heavy body relaxation. For the most sedating experience, choose Bubba Kush or Hindu Kush. For balanced effects with OG Kush is the iconic choice. For visual appeal, Purple Kush develops deep purple colouring. For yield, Critical Kush and Master Kush are heavy producers. Consider growing difficulty — most kush strains are beginner to intermediate friendly.' },
  ...
  'best-seller': {
    ...
    bottomSections: [
      { title: 'Why Choose Best-Selling Cannabis Seeds?', content: 'Best sellers become best sellers for a reason. These strains have been grown by thousands of Australian cultivators and consistently deliver on their promises — reliable germination, predictable growth, and excellent results. When you choose a best-selling strain, you benefit from the collective experience of the growing community. There are abundant grow journals, feeding schedules, and troubleshooting advice available for popular strains, making them easier to grow successfully.' },
      { title: 'Top Best-Selling Strains at Royal King Seeds', content: 'Our consistently top-selling strains include Gorilla Glue (extreme potency and yield), Girl Scout Cookies (iconic hybrid flavour), Blue Dream (beginner-friendly balance), Northern Lights (the easiest indoor strain), Wedding Cake (sweet flavour and high THC), OG Kush (West Coast classic), Gelato (exotic dessert terpenes), and White Widow (Dutch coffeeshop legend). These strains are popular across all experience levels from first-time growers to commercial cultivators.' },
  ...
  'best-strains-for-high-yield': {
    ...
    bottomSections: [
      ...
      { title: 'How to Choose the Right High-Yield Strain', content: 'Consider your grow space and setup. For small tents (2x2, 2x4), choose compact high-yield strains like Northern Lights or Critical. For larger spaces (4x4+), bigger strains like Big Bud and White Widow can spread out and maximise production. For outdoor growing, select strains that finish flowering before your local frost date. Autoflower high-yield strains are best for multiple fast harvests per year. Use our yield calculator to estimate harvest weight for your specific setup.' },
      { title: 'Indoor vs Outdoor Yield — What to Expect', content: 'Indoor high-yield strains typically produce 400-600g per square meter under optimised lighting. A well-run 1.2m x 1.2m tent can yield 350-680g per harvest. Outdoor high-yield strains can produce 500-1000g+ per plant when given full sun, adequate space, and a long enough growing season. Autoflowering high-yield strains offer a middle ground — individually smaller harvests but 3-4 cycles per year indoors, potentially matching annual outdoor yields.' },
    ...
    faqs: [
      ...
      { q: 'How much can I yield in a 1.2m x 1.2m tent?', a: 'A well-optimised 1.2m x 1.2m tent with LED lighting can yield 350-680g per harvest using high-yield strains with training. Beginners can expect 230-450g. Use our yield calculator for a personalised estimate based on your exact setup and experience level.' },
      { q: 'Are autoflowers or feminised seeds better for yield?', a: 'Feminised photoperiod plants produce larger individual harvests (60-230g/plant), but autoflowers allow 3-4 cycles per year indoors. Annual yield can be comparable. For maximum single-harvest weight, choose feminised. For maximum annual production, autoflowers may win.' },
      ...
      { q: 'What light is best for maximum yield?', a: 'Modern LED panels and 600-1000W HPS lights both deliver excellent yields. LEDs are more energy-efficient and produce less heat. HPS is proven and cost-effective. Both achieve 150-375g per square metre. Higher wattage = more yield, up to a point of diminishing returns.' },
    ],
  },
  'best-strains-for-indoor-growing': {
    ...
    faqs: [
      ...
      { q: 'How many plants can I fit in a 1.2m x 1.2m tent?', a: 'Most growers run 4-9 plants in a 1.2m x 1.2m tent depending on pot size and training method. Four plants in 20-litre pots with ScrOG training will fill the canopy efficiently. Nine smaller plants in 11-litre pots work for sea of green (SOG) methods.' },
      { q: 'What yield can I expect from indoor growing?', a: 'Indoor yields range from 150-375g per square metre depending on strain, lighting, and technique. A 1.2m x 1.2m tent typically produces 230-570g per harvest. Use our yield calculator for estimates based on your specific setup.' },
  ...
  'best-strains-for-outdoor-growing': {
    ...
    intro: 'These cannabis strains are specifically selected for outdoor growing success across Australia. Whether you are cultivating in the tropical north of Queensland, the temperate gardens of Victoria, or the dry heat of South Australia, these weather-resistant genetics deliver reliable outdoor harvests. Outdoor growing offers the highest yield potential per plant — some strains produce over 500g per plant in optimal conditions. Browse our outdoor-optimised collection.',
    quickFacts: [
      { label: 'Yield Per Plant', value: '230-900+ g' },
      { label: 'Harvest Time', value: 'Mar-May (AU)' },
      { label: 'Light Source', value: 'Free Sunlight' },
      { label: 'Best For', value: 'Maximum Plant Size' },
    ],
    bottomSections: [
      { title: 'What Makes a Good Outdoor Cannabis Strain?', content: 'Successful outdoor strains share several traits: natural pest and mould resistance, tolerance to temperature fluctuations, ability to handle wind and rain, and finishing times that align with your local growing season. Indica-dominant and hybrid strains generally work better in southern regions like Victoria and Tasmania with shorter seasons, while sativa-dominant strains thrive in tropical and subtropical climates with longer warm periods. Autoflower strains are the safest outdoor bet in any climate due to their fast finish times.' },
      { title: 'Best Outdoor Strains by Australian Region', content: 'Victoria and Tasmania (cooler, shorter seasons): Northern Lights, White Widow, and autoflower varieties that finish before autumn frosts. Queensland and Northern Territory (hot, humid): mould-resistant strains like Blue Dream, Durban Poison, and sativa-dominant hybrids. South Australia and Western Australia (hot, dry): most strains thrive here — try Sour Diesel, Jack Herer, or any high-yield sativa. New South Wales: versatile climate suits a wide range of genetics. Northern Queensland: virtually any strain works in this ideal tropical growing climate.' },
      { title: 'How to Choose Outdoor Cannabis Seeds', content: 'Your number one consideration is your local climate and season length. Count the weeks from last spring frost (September-October) to first autumn frost (April-May) — this is your outdoor growing window. Photoperiod strains need this entire window. Autoflowers need only 10-12 weeks, making them viable almost anywhere. Consider humidity — if your autumn is wet, choose mould-resistant strains or fast finishers. Consider security — shorter, bushier plants are less visible than tall sativas.' },
      { title: 'Outdoor vs Indoor Growing — Advantages of Outdoor', content: 'Outdoor growing uses free sunlight — the most powerful and full-spectrum light source available. Outdoor plants can grow massive (2-4+ metres) and produce enormous yields per plant. There is no electricity cost, and natural airflow keeps plants healthy. The main disadvantages are limited to one harvest per year (unless using autoflowers), weather risks, pest pressure, and less control over growing conditions. Many growers run both indoor and outdoor grows to get the best of both worlds.' },
      { title: 'Outdoor Growing Tips for Australian Growers', content: 'Start seeds indoors in September-October and transplant outdoors after the last frost. Choose a north-facing location with maximum sun exposure (remember, north-facing catches the most sun in the Southern Hemisphere). Prepare soil with compost and amendments before planting. Use fabric pots or raised beds for better root aeration. Protect young plants from animals and pests. Monitor for mould starting in late summer as humidity rises. Harvest when trichomes are cloudy — do not wait for amber if rain is forecast. Check our outdoor growing guide for climate-specific advice.' },
    ],
    faqs: [
      { q: 'When should I plant cannabis outdoors in Australia?', a: 'Most Australian growers plant outdoors between October and December, after the risk of frost has passed. Autoflowering strains can be planted through to January since they finish faster. Harvest typically occurs between March and May depending on strain and location.' },
      ...
      { q: 'How much does an outdoor cannabis plant yield?', a: 'Outdoor yields range widely: 200-900+ grams per plant depending on strain, climate, and growing technique. In ideal conditions (Queensland, Northern Territory), experienced growers regularly achieve 1kg+ per plant with high-yield genetics.' },
      { q: 'Can I grow cannabis outdoors in cold climates?', a: 'Yes, but choose fast-finishing strains or autoflowers. Northern Lights, Early Girl, and auto strains finish before autumn frosts arrive in cooler regions like Tasmania and Victoria. Start seeds indoors and transplant out after the last frost to maximise your growing season.' },
      ...
      { q: 'Do I need to water outdoor cannabis plants?', a: 'Yes, especially during hot summer months (December-February in Australia). Outdoor plants in the ground need 4-12 litres per day in peak summer. Container plants need more frequent watering. Mulching helps retain soil moisture. Water early morning or evening to reduce evaporation.' },
    ],
  },
  'fast-flowering-seeds': {
    h1: 'Fast Flowering Cannabis Seeds Australia — Quick Harvest Strains',
    intro: 'Fast flowering cannabis seeds combine photoperiod genetics with accelerated flowering times, typically finishing 1-2 weeks earlier than standard strains. Ideal for outdoor growers in cooler Australian regions like Victoria and Tasmania who need to harvest before autumn frosts, and indoor growers who want faster turnaround between cycles. These strains maintain the potency and yield of standard photoperiod genetics while shaving critical weeks off the flowering timeline.',
    quickFacts: [
  ...
  'classic-cannabis-seeds': {
    ...
    bottomSections: [
      ...
      { title: 'Top Classic Strains for Australian Growers', content: 'Our classic collection features Northern Lights (the easiest strain to grow, period), White Widow (Dutch coffeeshop legend), OG Kush (West Coast icon), AK-47 (one-hit wonder), Skunk #1 (the backbone of modern breeding), Amnesia Haze (cerebral powerhouse), Blue Dream (Californian-origin favourite), Sour Diesel (legendary energiser), and Jack Herer (named after the cannabis activist). Each has decades of proven performance behind it.' },
    ],
    faqs: [
  ...
  'fruity-cannabis-seeds': {
    h1: 'Fruity Cannabis Seeds Australia — Sweet & Tropical Flavor Genetics',
  ...
  'energizing-cannabis-seeds': {
    h1: 'Energizing Cannabis Seeds Australia — Stimulating Daytime Strains',
    ...
    bottomSections: [
      ...
      { title: 'Best Energizing Cannabis Strains', content: 'Our top energizing strains include Sour Diesel (intense fuel-powered energy), Green Crack (focused stimulation), Jack Herer (clear-headed motivation), Durban Poison (pure African sativa energy), Super Lemon Haze (citrus-powered uplift), and Tangie (tangerine-flavoured focus). These strains are popular among creative professionals, athletes, and anyone who wants productive cannabis without sedation.' },
    ],
    faqs: [
  ...
  'feminized-hybrids': {
    h1: 'Feminized Hybrid Cannabis Seeds Australia — Best of Both Worlds',
  ...
  'feminized-indicas': {
    h1: 'Feminized Indica Cannabis Seeds Australia — Relaxing Female Plants',
  ...
  'feminized-sativas': {
    h1: 'Feminized Sativa Cannabis Seeds Australia — Energizing Female Plants',
  ...
  'auto-flowering-sativas': {
    ...
    bottomSections: [
      { title: 'Why Choose Autoflower Sativa Seeds?', content: 'Pure photoperiod sativas can grow 3+ metres tall and take 14+ weeks to flower — challenging for most home growers. Autoflower sativa seeds solve these problems by keeping sativa effects in a compact, fast-finishing format. They stay under 120cm tall and finish in 9-11 weeks from seed. You get the cerebral energy, creativity, and euphoria of sativa genetics without the space and time requirements. Popular auto sativas include Amnesia Haze Auto, Jack Herer Auto, and Sour Diesel Auto.' },
    ],
    faqs: [
      { q: 'Are autoflower sativas shorter than regular sativas?', a: 'Yes, significantly. Regular sativa plants can reach 3+ metres. Autoflower sativa versions stay 60-120cm tall due to their ruderalis genetics. This makes sativa effects accessible to indoor growers with limited space.' },
    ],
  },
  'growers-choice-seeds-collection': {
    ...
    bottomSections: [
      { title: 'How We Choose Our Grower\'s Choice Picks', content: 'Our cultivation team evaluates every strain in our catalog based on germination reliability, growth vigor, yield consistency, terpene quality, potency, and overall growing experience. Strains that excel across all metrics earn a spot in the Grower\'s Choice collection. These are the genetics we confidently recommend to any grower, regardless of experience level. We update this collection regularly based on new strain releases and ongoing customer feedback from 200,000+ Australian growers.' },
    ],
    faqs: [
      { q: 'What makes Grower\'s Choice strains special?', a: 'These strains are hand-selected by our cultivation team based on all-around excellence: germination rate, growth vigor, yield, potency, and terpene quality. They represent our highest-confidence recommendations for Australian growers at any experience level.' },
    ],
  },
};
