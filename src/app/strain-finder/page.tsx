...
export const metadata: Metadata = {
  ...
  description: 'Use our free cannabis strain finder tool to discover the best weed strains for your needs. This marijuana strain selector quiz matches you with the right cannabis seeds based on effects, THC level, grow difficulty, and flavour in under 60 seconds.',
  ...
  alternates: { canonical: 'https://royalkingseeds.au/strain-finder' },
  openGraph: {
    title: 'Cannabis Strain Finder Tool — Find the Best Weed Strain for Your Needs',
    description: 'Free cannabis strain finder tool — discover the best weed strains based on effects, experience level, climate, and flavour. Personalized marijuana strain recommendations in 60 seconds.',
    url: 'https://royalkingseeds.au/strain-finder',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — most cannabis strains can be grown both indoors and outdoors, though some weed strains perform better in specific environments. Autoflower cannabis seeds and compact indica strains thrive indoors, while tall sativas and mould-resistant marijuana strains excel outdoors. Our weed strain finder quiz matches cannabis seeds to your grow environment so you get strains that will thrive where you grow.',
  },
  {
...
export default async function StrainFinderPage() {
  ...
  const toolSchema = {
    ...
    description: 'Free cannabis strain finder tool and weed strain selector quiz that matches users with the best marijuana strains based on desired effects, THC level, growing experience, climate, and flavour preferences.',
    url: 'https://royalkingseeds.au/strain-finder',
      ...
      <div className="bg-[#275C53] text-white">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
          ...
          <p className="text-white/75 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed mb-4">
            Use our cannabis strain finder tool to quickly discover the best weed strains for your needs. This marijuana strain selector helps you find the right cannabis seeds based on desired effects, THC level, growing environment, and flavour preferences. Whether you&apos;re looking for relaxing indica strains, energizing sativas, or beginner-friendly <Link href="/product-category/autoflowering-seeds" className="text-[#D7B65D] hover:text-white underline underline-offset-2">autoflower seeds</Link>, our weed strain quiz matches you with the right genetics from over 1,200 strains.
          </p>
      ...
      <div className="bg-white border-t border-[#275C53]/5">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-14">
          <div className="max-w-3xl mx-auto">
            ...
            <p className={pClass}>
              Not every strain is easy to grow. Some require precise humidity control, specific nutrient schedules, or advanced training techniques. If you&apos;re asking &ldquo;what strain should I grow?&rdquo; for the first time, stick with beginner-rated genetics — strains labeled as easy to grow, mould-resistant, and forgiving of minor mistakes. <Link href="/product-category/autoflowering-seeds" className="text-[#275C53] font-medium hover:text-[#D7B65D] underline underline-offset-2">Autoflowering seeds</Link> are particularly beginner-friendly since they flower on their own schedule without light cycle changes.
            </p>
            ...
            <p className={pClass}>
              Cannabis flavour isn&apos;t just about taste — terpenes influence effects too. Myrcene (earthy, musky) promotes relaxation. Limonene (citrus) tends toward mood elevation. Caryophyllene (peppery) may help with inflammation. Our quiz includes a flavour preference step so you can find strains like <Link href="/product-category/fruity-cannabis-seeds" className="text-[#275C53] font-medium hover:text-[#D7B65D] underline underline-offset-2">fruity cannabis seeds</Link>, diesel-forward genetics, or earthy <Link href="/product-category/kush-seeds" className="text-[#275C53] font-medium hover:text-[#D7B65D] underline underline-offset-2">kush varieties</Link> based on what appeals to you.
            </p>
            ...
            <p className={pClass}>
              Growing in Tasmania is very different from growing in Queensland. Cold climates with short seasons demand <Link href="/product-category/fast-flowering-seeds" className="text-[#275C53] font-medium hover:text-[#D7B65D] underline underline-offset-2">fast-flowering strains</Link> or autoflowers that finish before frost. Hot, dry climates favour sativa-leaning genetics with open bud structures that resist mould. Humid regions need strains with natural mould resistance. Our strain finder&apos;s climate step ensures your recommendations actually suit your environment.
            </p>
            ...
            <p className={pClass}>
              <strong>Step 1:</strong> You answer 6 quick questions about your desired experience, potency preference, growing environment, skill level, flavour taste, and climate. Each question takes just a few seconds — most people finish the entire quiz in under 60 seconds.
            </p>
            <p className={pClass}>
              ...
              {[
                {
                  ...
                  desc: 'Forgiving, mould-resistant, and easy to grow. Autoflowering varieties like Northern Lights Auto, Blue Dream Auto, and White Widow Auto are perfect first-time grows.',
                ...
                },
                {
                  ...
                  desc: 'Hardy genetics built for real-world conditions. Mold-resistant, pest-tolerant strains that thrive in gardens, balconies, and open fields across Australia.',
                ...
                },
                {
                  ...
                  desc: 'Sweet, berry-forward, and tropical flavour profiles. Strains like Zkittlez, Gelato, Strawberry Banana, and Blueberry deliver exceptional taste and smooth smoke.',
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                { bold: 'Matches effects, flavour, and climate', text: ' — our weed strain finder evaluates six dimensions simultaneously: desired effects, potency, grow location, skill level, flavour preferences, and climate compatibility.' },
            ...
            <div className="bg-[#275C53] rounded-2xl p-8 sm:p-10 text-center text-white">
              ...
              <p className="text-white/80 text-sm max-w-lg mx-auto mb-6">
                Our cannabis strain finder quiz takes less than 60 seconds. Get personalized recommendations from over 1,200 strains — matched to your effects, flavour, climate, and skill level.
              </p>
