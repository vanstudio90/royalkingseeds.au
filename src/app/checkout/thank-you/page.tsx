      ...
      <div className="bg-white rounded-2xl border border-[#275C53]/10 p-6 mb-8 text-left space-y-4">
        <div>
          ...
          <ul className="text-[13px] text-[#192026]/60 space-y-2">
            ...
            <li className="flex items-start gap-2"><span className="text-[#275C53] font-bold">4.</span> Delivery typically takes 3-7 business days across Australia.</li>
          </ul>
        </div>
        <div className="pt-4 border-t border-[#192026]/5">
          ...
          <p className="text-[13px] text-[#192026]/60">
            Contact us at <a href="mailto:support@royalkingseeds.au" className="text-[#275C53] font-medium">support@royalkingseeds.au</a> with your order number.
          </p>
        </div>
      </div>
