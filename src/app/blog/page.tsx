...
export const metadata: Metadata = {
  ...
  description: 'Expert cannabis growing guides, germination walkthroughs, strain reviews, troubleshooting help, and harvest advice. Written by cultivators for 200,000+ Australian growers.',
  alternates: { canonical: 'https://royalkingseeds.au/blog' },
};
...
export default function BlogPage() {
  ...
  const formatDate = (d: string) => new Date(d).toLocaleDateString('en-AU', { month: 'short', day: 'numeric', year: 'numeric' });
    ...
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
      ...
      <section className="py-12 text-center">
        ...
        <p className="text-[#192026]/55 max-w-2xl mx-auto text-sm leading-relaxed mb-6">
          Expert guides on germination, indoor growing, outdoor harvests, strain selection, and troubleshooting. Written by cultivators for 200,000+ Australian growers.
        </p>
        ...
        <aside className="w-full lg:w-[300px] shrink-0 space-y-5 lg:self-start lg:sticky lg:top-4 lg:pb-8">
          ...
          <div className="bg-[#F5F0EA] rounded-2xl p-5">
            ...
            <p className="text-[12px] text-[#192026]/50 leading-relaxed">
              Every article is written from hands-on growing experience and reviewed for accuracy. Our guides have helped 200,000+ Australian growers succeed.
            </p>
          </div>
