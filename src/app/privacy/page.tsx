...
export const metadata: Metadata = {
  ...
  description: 'How Royal King Seeds collects, uses, and protects your personal information. Read our privacy policy for Australian customers.',
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
      <div className="max-w-3xl mx-auto prose prose-sm text-[#192026]/80 prose-headings:text-[#275C53] prose-headings:font-normal">
        ...
        <h2>Your Rights</h2>
        <p>You may request access to, correction of, or deletion of your personal data by contacting us at support@royalkingseeds.au. Australian residents have rights under the Privacy Act 1988 and the Australian Privacy Principles (APPs).</p>
        <h2>Contact Us</h2>
        <p>For privacy-related inquiries, contact us at <a href="mailto:support@royalkingseeds.au">support@royalkingseeds.au</a>.</p>
