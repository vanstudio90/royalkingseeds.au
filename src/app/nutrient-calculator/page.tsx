        ...
        <div className="flex-1 min-w-0 w-full">
          ...
          <div className="space-y-10 max-w-3xl">
            ...
            <section>
              ...
              <p className="text-[14px] text-[#192026]/65 leading-relaxed mb-3"><strong>PPM (Parts Per Million)</strong> is another way to measure nutrient concentration. There are two PPM scales: the 500 scale (multiply EC by 500) and the 700 scale (multiply EC by 700). Our calculator uses the 500 scale, which is widely used in Australia. When reading PPM values from other sources, confirm which scale they use.</p>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                {[
                  ...
                  { title: 'Root Zone Problems', desc: 'Compacted soil, root-bound pots, poor drainage, or cold root zones all prevent nutrient absorption regardless of what you feed. Healthy roots = healthy uptake. Check your container size, drainage, and root zone temperature (18-24°C ideal).', icon: '🌱' },
                ].map(item => (
                  <div key={item.title} className="bg-white rounded-xl border border-[#275C53]/5 p-4">
            ...
            <section>
              ...
              <p className="text-[14px] text-[#192026]/65 leading-relaxed mb-3">Our nutrient calculator is built on real growing data from 200,000+ Australian growers who have used seeds from Royal King Seeds across soil, coco coir, and hydroponic systems. The EC and PPM ranges reflect what actually works in practice — not theoretical maximums from nutrient company marketing.</p>
              ...
              <p className="text-[14px] text-[#192026]/65 leading-relaxed">Our feeding data is updated regularly based on customer feedback, new strain releases, and evolving best practices in cannabis cultivation. Every recommendation is designed to be practical, safe, and effective for home growers across Australia. For personalized growing support, our team is available through our <Link href="/contact" className="text-[#275C53] hover:text-[#D7B65D]">contact page</Link>.</p>
            </section>
