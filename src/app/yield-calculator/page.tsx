        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-10 max-w-3xl">
            ...
            <section>
              ...
              <p className="text-[14px] text-[#192026]/65 leading-relaxed mb-3">This calculator is based on real grow data and industry-standard yield ranges used by indoor and outdoor cultivators across Australia. The logic reflects what 200,000+ Australian growers have reported when using seeds from Royal King Seeds.</p>
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { q: 'How much does an outdoor cannabis plant yield?', a: 'A single outdoor cannabis plant can yield 1–5+ ounces depending on strain, climate, and growing season length. In warm climates with long seasons (Queensland, Northern Territory), plants can reach massive sizes. High-yield outdoor strains like Big Bud and Critical Mass are bred for heavy harvests.' },
