  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
      <div className="max-w-3xl mx-auto prose prose-sm text-[#192026]/80 prose-headings:text-[#275C53] prose-headings:font-normal">
        ...
        <h2>Australian Cannabis Law Overview</h2>
        <p>Cannabis laws in Australia vary significantly by state and territory. The Australian Capital Territory has legalised personal cannabis cultivation for adults, while other states and territories maintain different restrictions on cannabis seeds and cultivation. It is the buyer&apos;s sole responsibility to research and comply with the laws in their specific jurisdiction before germinating any seeds.</p>
