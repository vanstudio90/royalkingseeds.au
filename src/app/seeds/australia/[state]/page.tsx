...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Buy premium cannabis seeds in ${stateName} with fast, discreet shipping. Feminised, autoflower, and CBD seeds. 95% germination guarantee. Best strains for ${stateName} climate.`;

  return {
    title,
    description,
    alternates: { canonical: `${BASE}/seeds/australia/${stateSlug}` },
    openGraph: {
      title,
      description,
      type: 'website',
      url: `${BASE}/seeds/australia/${stateSlug}`,
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-8">
      ...
      <nav className="text-[12px] text-[#192026]/50 mb-6 flex items-center gap-1.5 flex-wrap">
        ...
        <span>/</span>
        <Link href="/seeds/australia" className="hover:text-[#275C53]">Australia</Link>
        <span>/</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10">
        ...
        <main>
          <header className="mb-8">
            ...
            <p className="text-[#192026]/70 text-sm sm:text-base leading-relaxed max-w-3xl">
              ...
              fast delivery. Browse 1,200+ strains including feminised, autoflower, and CBD
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                {cities.map((c) => (
                  <Link
                    key={c.slug}
                    href={`/seeds/australia/${stateSlug}/${c.slug}`}
          ...
          {related.length > 0 && (
            <section className="mb-10 pt-8 border-t border-[#275C53]/10">
              <h3
                ...
                style={{ fontFamily: 'var(--font-patua)' }}
              >
                Nearby States &amp; Territories
              </h3>
              <div className="flex flex-wrap gap-2">
                {related.map((r) => (
                  <Link
                    key={r.slug}
                    href={`/seeds/australia/${r.slug}`}
        ...
        <aside className="space-y-8">
          ...
          <div className="bg-[#275C53] rounded-2xl p-6 text-center">
            ...
            <p className="text-white/70 text-[12px] mb-4">1,200+ strains with Australia-wide shipping</p>
            <Link
              href="/product-category/shop-all-cannabis-seeds"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: stateName, item: `${BASE}/seeds/australia/${stateSlug}` },
            ],
          }),
        }}
      />
          ...
          __html: JSON.stringify({
            ...
            mainEntity: {
              ...
              itemListElement: cities.slice(0, 20).map((c, i) => ({
                ...
                url: `${BASE}/seeds/australia/${stateSlug}/${c.slug}`,
              })),
            },
          }),
        }}
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: `Yes. Cannabis seeds are sold as adult novelty souvenirs and collectible genetics. Royal King Seeds ships discreetly to ${stateName} with fast delivery.`,
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: `The best strains for ${stateName} depend on your local climate and grow setup. Autoflower seeds are great for shorter seasons, while feminised photoperiod strains work well for indoor growers. Check our ${stateName} city guides for climate-specific recommendations.`,
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: `Royal King Seeds typically delivers to ${stateName} within 3-7 business days using discreet packaging with no cannabis-related markings.`,
                },
              },
            ],
          }),
