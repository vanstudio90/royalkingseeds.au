...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Buy premium cannabis seeds in ${cityName}, ${stateName}. Discreet shipping, 95% germination guarantee. Feminised, autoflower, and CBD strains for ${cityName} growers.`;

  return {
    title,
    description,
    alternates: { canonical: `${BASE}/seeds/australia/${stateSlug}/${citySlug}` },
    openGraph: {
      title,
      description,
      type: 'website',
      url: `${BASE}/seeds/australia/${stateSlug}/${citySlug}`,
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-8">
      ...
      <nav className="text-[12px] text-[#192026]/50 mb-6 flex items-center gap-1.5 flex-wrap">
        ...
        <span>/</span>
        <Link href={`/seeds/australia/${stateSlug}`} className="hover:text-[#275C53]">{stateName}</Link>
        <span>/</span>
      ...
      <header className="mb-8">
        ...
        <p className="text-[#192026]/70 text-sm sm:text-base leading-relaxed max-w-3xl">
          ...
          packaging and fast shipping. Shop 1,200+ strains with our 95% germination guarantee.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
        <Link
          href={`/seeds/australia/${stateSlug}`}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: cityName, item: `${BASE}/seeds/australia/${stateSlug}/${citySlug}` },
            ],
          }),
        }}
      />
