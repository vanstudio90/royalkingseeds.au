...
export const metadata: Metadata = {
  ...
  description: 'Join the Royal King Seeds affiliate program. Earn commissions promoting premium cannabis seeds to Australian growers.',
    ...
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-[#275C53] rounded-2xl p-8 text-center">
          ...
          <p className="text-white/70 text-sm mb-6">Email us at support@royalkingseeds.au with &ldquo;Affiliate&rdquo; in the subject line and we&apos;ll get you set up.</p>
          <a href="mailto:support@royalkingseeds.au?subject=Affiliate Program" className="btn-main !bg-[#D7B65D] !text-[#1a3d36]">Apply Now</a>
        </div>
      </div>
    </div>
  );
