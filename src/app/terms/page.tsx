  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
      <div className="max-w-3xl mx-auto prose prose-sm text-[#192026]/80 prose-headings:text-[#275C53] prose-headings:font-normal">
        ...
        <p>All prices are listed in Australian Dollars (AUD). We reserve the right to modify prices without notice. Payment is required at the time of order. We accept Visa, Mastercard, and cryptocurrency.</p>
        <h2>Shipping</h2>
        <p>We ship to all Australian states and territories. Delivery times are estimates and not guarantees. Royal King Seeds is not responsible for delays caused by shipping carriers or other factors beyond our control.</p>
        ...
        <h2>Contact</h2>
        <p>For questions about these terms, contact us at <a href="mailto:support@royalkingseeds.au">support@royalkingseeds.au</a>.</p>
